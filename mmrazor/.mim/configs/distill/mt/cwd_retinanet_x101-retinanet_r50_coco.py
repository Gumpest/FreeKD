...
teacher = dict(
    type='mmdet.RetinaNet',
    init_cfg=dict(type='Pretrained', checkpoint='/mnt/workspace/mnt3/sujin.zy/mmrazor/token_ckpt/retinanet_x101_64x4d_fpn_mstrain_3x_coco_20210719_051838-022c2187.pth'),
    backbone=dict(
        type='ResNeXt',
        depth=101,
        groups=64,
