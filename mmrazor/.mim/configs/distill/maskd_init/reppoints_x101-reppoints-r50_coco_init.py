...
student = dict(
    ...
    neck=dict(
        ...
        init_cfg=dict(type='Pretrained', prefix='neck', checkpoint='token_ckpt/reppoints_moment_x101_fpn_dconv_c3-c5_gn-neck+head_2x_coco_20200329-f87da1ea.pth')),
    bbox_head=dict(
        type='RepPointsHead',
        num_classes=80,
        in_channels=256,
        ...
        norm_cfg=dict(type='GN', num_groups=32, requires_grad=True),
        init_cfg=dict(type='Pretrained', prefix='bbox_head', checkpoint='token_ckpt/reppoints_moment_x101_fpn_dconv_c3-c5_gn-neck+head_2x_coco_20200329-f87da1ea.pth')),
            ...
            dict(
                ...
                losses=[
                    dict(
                        ...
                        pretrained='token_ckpt/maskd_reppoints_moment_x101_fpn_dconv_c3-c5_gn-neck.2Bhead_2x_coco_20220530.pth',
                        loss_weight=15,
                    ),
                ],
                align_module=dict(
