...
student = dict(
    ...
    neck=dict(
        ...
        out_channels=256,
        num_outs=5,
        init_cfg=dict(type='Pretrained', prefix='neck', checkpoint='https://download.openmmlab.com/mmdetection/v2.0/cascade_rcnn/cascade_mask_rcnn_x101_64x4d_fpn_20e_coco/cascade_mask_rcnn_x101_64x4d_fpn_20e_coco_20200512_161033-bdb5126a.pth')),
    rpn_head=dict(
        type='RPNHead',
        in_channels=256,
        feat_channels=256,
        ...
        init_cfg=dict(type='Pretrained', prefix='rpn_head', checkpoint='https://download.openmmlab.com/mmdetection/v2.0/cascade_rcnn/cascade_mask_rcnn_x101_64x4d_fpn_20e_coco/cascade_mask_rcnn_x101_64x4d_fpn_20e_coco_20200512_161033-bdb5126a.pth')),
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            loss_bbox=dict(type='L1Loss', loss_weight=1.0))),
        # init_cfg=dict(type='Pretrained', prefix='roi_head.bbox_head.0', checkpoint='https://download.openmmlab.com/mmdetection/v2.0/cascade_rcnn/cascade_mask_rcnn_x101_64x4d_fpn_20e_coco/cascade_mask_rcnn_x101_64x4d_fpn_20e_coco_20200512_161033-bdb5126a.pth')),
            ...
            dict(
                ...
                losses=[
                    dict(
                        ...
                        weight_mask=True,
                        custom_mask=True,
                        custom_mask_warmup=6500,
                        pretrained='token_ckpt/maskd_cascade_mask_rcnn_x101_64x4d_fpn_20e_coco_20220530.pth',
                        loss_weight=1,
                    ),
                ],
                align_module=dict(
