...
teacher = dict(
    type='mmdet.RetinaNet',
    init_cfg=dict(type='Pretrained', checkpoint='https://download.openmmlab.com/mmdetection/v2.0/retinanet/retinanet_x101_64x4d_fpn_2x_coco/retinanet_x101_64x4d_fpn_2x_coco_20200131-bca068ab.pth'),
    backbone=dict(
        type='ResNeXt',
        depth=101,
        groups=64,
            ...
            dict(
                ...
                losses=[
                    dict(
                        ...
                        pretrained='/data/zhangyuan.sujin/mmdetection/work_dirs/retinanet_x101_64x4d_fpn_2x_coco/iter_2000.pth',
                        loss_weight=7,
                    ),
                ],
                align_module=dict(
